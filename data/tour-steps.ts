...
export const overviewTourSteps: TourStep[] = [
  ...
  },
  {
    ...
    body: "Quatre questions, quatre reponses : est-ce qu'on tient, qu'est-ce qui vend, qu'est-ce qui bloque, qu'est-ce qui presse. Tresorerie, dates a vendre et dossiers sont calcules depuis les donnees de la compagnie.",
  },
  {
    id: "priorite",
    path: "/dashboard",

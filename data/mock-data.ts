...
export const showDocuments: ShowDocument[] = [
  {
    ...
    status: "Pret",
    fileUrl: "https://example.com/dossier-artistique.pdf",
...
export const contacts: Contact[] = [
  ...
  },
  {
    ...
    contactType: "venue",
    venueId: "",
    name: "Scene nationale du Littoral",
    organization: "Scene nationale du Littoral",
    role: "Lieu",
    email: "contact@littoral.fr",
    phone: "05 46 00 00 01",
    city: "La Rochelle",
    address: "Parvis des Arts",
    postalCode: "17000",
    department: "Charente-Maritime",
    region: "Nouvelle-Aquitaine",
    website: "https://example.com/littoral",
    capacity: 620,
    latitude: 46.1603,
    longitude: -1.1511,
    status: "En discussion",
  ...
  },
  {
    ...
    contactType: "venue",
    venueId: "",
    name: "Festival Passages",
    organization: "Festival Passages",
    role: "Lieu",
    email: "contact@passages.fr",
    phone: "03 87 00 00 02",
    city: "Metz",
    address: "Place de la Comédie",
    postalCode: "57000",
    department: "Moselle",
    region: "Grand Est",
    website: "https://example.com/passages",
    capacity: 380,
    latitude: 49.1193,
    longitude: 6.1757,
    status: "Prospect",
  ...
  },
  {
    ...
    website: "https://example.com/theatre-du-nord",
    capacity: 465,
    latitude: 50.6292,
    longitude: 3.0573,
    status: "Partenaire",

    ...
    <Card className="w-full max-w-md border-accent/25 bg-panel/95">
      <div className="mb-6">
        ...
        <p className="mt-3 text-sm leading-6 text-muted">
          ...
          bêta de lancement a 19,99 EUR / mois.
        </p>
      </div>
      <div className="rounded-lg border border-border bg-panel-strong/60 p-4 text-sm text-muted">
        ...
        <p className="mt-1">
          Reserve ta place bêta. On activera ensuite ton accès manuellement pour garder une
      ...
      <p className="mt-6 text-center text-sm text-muted">
        Besoin d&apos;un accès de demo ?{" "}
        <Link href="/beta" className="font-medium text-accent">
          Passe par la liste bêta
        </Link>
      </p>
    </Card>
  );

  ...
  return (
    <Card className="space-y-5 p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-start gap-3"><Bot className="mt-0.5 h-5 w-5 text-accent" /><div><p className="font-semibold">William</p><p className="mt-1 text-sm text-muted">Assistant IA en acces progressif. Les credits supplementaires ne disparaissent pas a la fin du mois.</p></div></div>

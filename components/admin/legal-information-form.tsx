    ...
    <Card className="space-y-6 p-5">
      <div>
        ...
        <p className="mt-1 text-sm text-muted">
          Ces valeurs alimentent immediatement les mentions legales, CGU, CGV et pages RGPD.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Field label="Telephone professionnel"><Input value={value.professionalPhone} onChange={(event) => update("professionalPhone", event.target.value)} /></Field>
      ...
      <Field label="Prix beta affiche"><Input value={value.betaPrice} onChange={(event) => update("betaPrice", event.target.value)} /></Field>

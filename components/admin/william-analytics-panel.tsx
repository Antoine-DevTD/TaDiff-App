  ...
  return (
    <Card className="space-y-5 p-5">
      <div className="flex items-start gap-3">
        ...
        <div><h3 className="text-xl font-semibold">Questions posees a William</h3><p className="mt-1 text-sm text-muted">Vue agregee sur 30 jours, conservation maximale de 90 jours. Les emails et numeros de téléphone sont masques avant enregistrement.</p></div>
      </div>
...
function Empty() { return <p className="rounded-md border border-dashed border-border p-4 text-sm text-muted">Les premières données apparaitront après application de la migration 043.</p>; }
